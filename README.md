...
!\[Global CO2 Emissions](images/global\_co2\_emissions\_over\_time.png)
...
!\[Major Countries Comparison](images/major\_countries\_co2\_comparison.png)
...
!\[Average GHG by Decade](images/average\_ghg\_emissions\_by\_decade.png)
...
!\[Feature Importance](images/random\_forest\_feature\_importance.png)
...
!\[Linear Regression](images/linear\_regression\_united\_states.png)
...
!\[ETS Forecast](images/ets\_forecast\_united\_states.png)
...
!\[ETS Forecast CI](images/ets\_forecast\_ci\_united\_states.png)
...
| `ghg\_features.csv` | Engineered features used for machine learning |

| `forecast\_summary.csv` | Forecast evaluation summary |

| `ets\_forecast\_2043.csv` | Future CO₂ emission forecasts |
...
jupyter notebook notebooks/ghg\_analysis.ipynb
